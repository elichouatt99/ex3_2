 ...
 * It checks ball's collision counter every frame, and once the it finds the ball has collided countDownValue times
...
public class BallCollisionCountdownAgent extends GameObject {
    ...
    public BallCollisionCountdownAgent(Ball ball,
        ...
        this.countStart = ball.getCollisionCount();
    }
    ...
    public void update(float deltaTime){
        ...
        if (ball.getCollisionCount() - countStart == countDownValue){
